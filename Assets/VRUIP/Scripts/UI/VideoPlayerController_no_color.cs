...
namespace VRUIP
{
    public class VideoPlayerController_no_color : A_Canvas_no_color
    {
        ...
        [SerializeField] private IconController_no_color playButton;
        [SerializeField] private IconController_no_color volumeButton;
